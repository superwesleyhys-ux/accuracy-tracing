...
|---|---|---|---|
| v201 | elevated | ordinary (wrong) | elevated (correct) |
| v202 | ordinary | ordinary (correct) | ordinary (correct) |
| v203 | elevated | ordinary (wrong) | elevated (correct) |
| v204 | ordinary | ordinary (correct) | ordinary (correct) |
| v205 | elevated | ordinary (wrong) | elevated (correct) |
| v206 | ordinary | ordinary (correct) | ordinary (correct) |
| v207 | elevated | ordinary (wrong) | elevated (correct) |
| v208 | ordinary | ordinary (correct) | ordinary (correct) |
...
See `experiments/honest-system-holdout-20260911/PROTOCOL.md`, `REGISTRATION.json`,
`corpus.json`, and the run receipts in this directory. The sealed labels are copied to
`REVEALED_GOLD.json` after scoring; publisher-source receipts remain in the frozen corpus
audit metadata.
